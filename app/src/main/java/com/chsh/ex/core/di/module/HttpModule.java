...
import com.chsh.ex.core.http.api.ApiService;
import com.chsh.ex.core.http.interceptor.NetCacheInterceptor;
import com.chsh.ex.core.http.interceptor.OfflineCacheInterceptor;
import com.chsh.ex.utii.CacheUtils;
...
public class HttpModule {
    ...
    OkHttpClient provideOkHttpClient(OkHttpClient.Builder builder) {
        ...
        builder.cookieJar(new PersistentCookieJar(new SetCookieCache(),
                new SharedPrefsCookiePersistor(TopLiApp.getContext())));
