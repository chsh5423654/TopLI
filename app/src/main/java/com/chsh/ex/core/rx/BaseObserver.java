...
import com.chsh.ex.core.http.BaseResponse;
import com.chsh.ex.core.http.exception.ServerException;
import com.chsh.ex.utii.CommonUtils;
...
public abstract class BaseObserver<T> extends ResourceObserver<BaseResponse<T>> {
    ...
    public void onComplete() {
        ...
        if (!CommonUtils.isNetworkConnected()) {
            mView.showErrorMsg(TopLiApp.getContext().getString(R.string.http_error));
        }
