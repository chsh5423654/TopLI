...
package com.chsh.ex.core.preference;

import android.content.Context;
import android.content.SharedPreferences;

import com.chsh.ex.app.TopLiApp;
import com.chsh.ex.core.constant.Constants;
...
public class PreferenceHelperImpl implements PreferenceHelper {
    ...
    PreferenceHelperImpl() {
        mPreferences = TopLiApp.getContext().getSharedPreferences(Constants.MY_SHARED_PREFERENCE, Context.MODE_PRIVATE);
    }
