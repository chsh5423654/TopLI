package com.chsh.fragmentlibray.view;
...
import com.chsh.fragmentlibray.R;
import com.chsh.fragmentlibray.adapter.ViewPagerAdapter;
import com.chsh.fragmentlibray.constant.Anim;
import com.chsh.fragmentlibray.utils.NavigationUtil;
...
public class EasyNavigationBar extends LinearLayout {
    ...
    private EasyNavigationBar.OnSelectChangeListener onSelectChangeListener;
    //消息红点字体大小
...
//若没有设置中间添加的文字字体大小、颜色、则同其他Tab一样
    ...
    public interface OnSelectChangeListener {
        void onSelectChangeListener(int position);
    }

    public EasyNavigationBar ononSelectChangeListener(EasyNavigationBar.OnSelectChangeListener onSelectChangeListener) {
